        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Video = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false),
                    Price = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitPayments", x => new { x.StudentId, x.UnitId });
                    table.ForeignKey(
                        name: "FK_UnitPayments_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonPayments", x => new { x.StudentId, x.LessonId });
                    table.ForeignKey(
                        name: "FK_LessonPayments_Lesson_LessonId",
                        column: x => x.LessonId,
